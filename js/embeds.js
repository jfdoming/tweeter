{
	let load = (embeds) => {
		...
		embeds.push("plant", "cbc.ca", "Robots set to take over jobs at manufacturing plant", "Future uncertain for workers desperate for wages", "img/embed/renewables.jpg");
		embeds.push("times", "cbc.ca", "Androids protest in Berlin, demand equal rights", "Leader says more is to come");
		embeds.push("opinion", "cbc.ca", "[OPINION] Cyborgs are our equals, and we should treat them as such; give them the right to live", "They have the ability to think and feel just as we do.");
	};
